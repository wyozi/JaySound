...
public abstract class FourierTransform
{
  ...
  protected void setComplex(float[] r, float[] i)
  {
    ...
    {
      System.err.println("FourierTransform.setComplex: the two arrays must be the same length as their member counterparts.");
    }
    else
    {
  ...
  public void linAverages(int numAvg)
  {
    ...
    {
      System.err.println("The number of averages for this transform can be at most "
          + spectrum.length / 2 + ".");
      return;
    }
    else
